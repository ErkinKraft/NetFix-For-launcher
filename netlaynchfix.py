...
if launcher_choice == "help":
    ...
    if langchos == '1':
        print('Эта программа (возможно) поможет ускорить загрузку игр или файлов в таких лаунчерах как Epic Games и Steam \n'
              'Программа закроет все процессы использующие интернет')
    if langchos == '2':
        print('This program will (probably) help speed up the download of games or files in such launchers as Epic Games and Steam \n'
